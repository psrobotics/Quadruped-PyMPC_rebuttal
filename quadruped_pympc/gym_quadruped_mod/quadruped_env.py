...
from .robot_cfgs import RobotConfig, get_robot_config
from .sensors.base_sensor import Sensor
from .utils.math_utils import _process_range, angle_between_vectors, homogenous_transform
from .utils.mujoco.terrain import generate_terrain
from .utils.mujoco.visual import change_robot_appearance, render_ghost_robot, render_vector
from .utils.quadruped_utils import (
    LegsAttr,
...
class QuadrupedEnv(gym.Env):
    ...
    def __init__(
        ...
        try:  # to load the robot's model on custom terrain scene.
            ...
            scene_env_path = base_scene_env_path
